...
public class Main {
    public static void main(String[] args) {
        ...
        Human h1= new Human ("Lidiya", "Karavaeva", 19);
        Human h2= new Human ("Daria", "Karavaeva", 18);
        Human h3= new Human ("David", "Pogosian", 19);
        humanArr.add(h1);
        humanArr.add(h2);
        humanArr.add(h3);
        ...
        String str=("The sun shines bright, bright in the sky.").toLowerCase();
